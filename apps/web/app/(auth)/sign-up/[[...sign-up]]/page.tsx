        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            ...
            <p className="mt-4 text-base text-white/50 leading-relaxed">
              Get access to all marketing materials, brochures, datasheets, and presentations
              for Ornate Solar products and partners.
            </p>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-[#F4F5F7] relative">
        ...
        <div className="relative z-10 w-full max-w-md px-6 animate-fade-in">
          ...
          <div className="mb-8 text-center lg:text-left">
            <h2 className="text-2xl font-bold tracking-tight text-[#1A1A1A]">Create your account</h2>
            <p className="mt-1 text-sm text-[#6B7280]">Get started with the Marketing Collateral Hub</p>
          </div>
